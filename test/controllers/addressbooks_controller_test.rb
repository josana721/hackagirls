...
class AddressbooksControllerTest < ActionController::TestCase
  ...
  test "should create addressbook" do
    assert_difference('Addressbook.count') do
      post :create, addressbook: { city: @addressbook.city, cnumber: @addressbook.cnumber, eadd: @addressbook.eadd, fname: @addressbook.fname, lname: @addressbook.lname, pic: @addressbook.pic, street: @addressbook.street, zipcode: @addressbook.zipcode }
    end
  ...
  test "should update addressbook" do
    patch :update, id: @addressbook, addressbook: { city: @addressbook.city, cnumber: @addressbook.cnumber, eadd: @addressbook.eadd, fname: @addressbook.fname, lname: @addressbook.lname, pic: @addressbook.pic, street: @addressbook.street, zipcode: @addressbook.zipcode }
    assert_redirected_to addressbook_path(assigns(:addressbook))
  end
